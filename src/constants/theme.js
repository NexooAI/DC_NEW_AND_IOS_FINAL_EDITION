...
const theme = {
  ...
  constants: {
    ...
    bottomNavStyle: themeConfig.bottomNavStyle || "v1_classic",
    bottomNavVersion: themeConfig.bottomNavVersion || 1,
    rewardScreenVersion: themeConfig.rewardScreenVersion || "v2",
    rewardsVersion: themeConfig.rewardsVersion || "v2",
    schemesVersion: themeConfig.schemesVersion || "v2",
    kycVersion: themeConfig.kycVersion || 2,
    kycScreenVersion: themeConfig.kycScreenVersion || "v2",
    showBottomNavDashboard: themeConfig.showBottomNavDashboard !== undefined ? themeConfig.showBottomNavDashboard : false,
